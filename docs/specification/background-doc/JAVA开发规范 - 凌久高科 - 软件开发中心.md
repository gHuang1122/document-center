...
1. 【推荐】图中默认上层依赖于下层，箭头关系表示可直接依赖，如：开放接口层可以依赖于 Web 层，也可以直接依赖于 Service 层，依此类推：
   ...
   [![未加载图片](https://github.com/mysterin/alibaba-java-specification/raw/master/app_layout.png)](https://github.com/mysterin/alibaba-java-specification/blob/master/app_layout.png)
